...
class EnvironmentChangerTransformer : Transformer() {
    ...
    init {
        ...
        register("v1_18_2/net/minecraft/world/World") { classNode: ClassNode -> transformWorld(classNode) }
        register("v1_18_2/net/minecraft/client/world/ClientWorld") { classNode: ClassNode -> transformClientWorld(classNode) }
        register("v1_18_2/net/minecraft/client/render/BackgroundRenderer") { classNode: ClassNode -> transformBackgroundRenderer(classNode) }
        register("v1_18_2/net/minecraft/client/render/WorldRenderer") { classNode: ClassNode ->
    ...
    private fun transformWorld(classNode: ClassNode) {
        val getSkyAngle = Identifier.parse("v1_18_2/net/minecraft/world/World#getSkyAngle(F)F")
        val getSkyAngleRadians = Identifier.parse("v1_18_2/net/minecraft/world/World#getSkyAngleRadians(F)F")
    ...
    private fun transformClientWorld(classNode: ClassNode) {
        val getSkyColor = Identifier.parse("v1_18_2/net/minecraft/client/world/ClientWorld#getSkyColor(Lv1_18_2/net/minecraft/util/math/Vec3d;F)Lv1_18_2/net/minecraft/util/math/Vec3d;")
        val getSkyAngle = Identifier.parse("v1_18_2/net/minecraft/client/world/ClientWorld#getSkyAngle(F)F")
        ...
        val method23787 = Identifier.parse("v1_18_2/net/minecraft/client/world/ClientWorld#method_23787(F)F")
        ...
        val getStarBrightness = Identifier.parse("v1_18_2/net/minecraft/client/world/ClientWorld#getStarBrightness(F)F")
        ...
        val getCloudsColor = Identifier.parse("v1_18_2/net/minecraft/client/world/ClientWorld#getCloudsColor(F)Lv1_18_2/net/minecraft/util/math/Vec3d;")
    ...
    private fun transformBackgroundRenderer(classNode: ClassNode) {
        val render = Identifier.parse("v1_18_2/net/minecraft/client/render/BackgroundRenderer#render(Lv1_18_2/net/minecraft/client/render/Camera;FLv1_18_2/net/minecraft/client/world/ClientWorld;IF)V")
    ...
    private fun transformWorldRenderer(classNode: ClassNode) {
        val getSkyAngle = Identifier.parse("v1_18_2/net/minecraft/client/world/ClientWorld#getSkyAngle(F)F")
        val renderSky = Identifier.parse("v1_18_2/net/minecraft/client/render/WorldRenderer#renderSky(Lv1_18_2/net/minecraft/client/util/math/MatrixStack;Lv1_18_2/net/minecraft/util/math/Matrix4f;FLjava/lang/Runnable;)V")
        ...
        val getTime = Identifier.parse("v1_18_2/net/minecraft/client/world/ClientWorld#getTime()J")
        ...
        val getRainGradient = Identifier.parse("v1_18_2/net/minecraft/client/world/ClientWorld#getRainGradient(F)F")

        val renderWeather = Identifier.parse("v1_18_2/net/minecraft/client/render/WorldRenderer#renderWeather(Lv1_18_2/net/minecraft/client/render/LightmapTextureManager;FDDD)V")
