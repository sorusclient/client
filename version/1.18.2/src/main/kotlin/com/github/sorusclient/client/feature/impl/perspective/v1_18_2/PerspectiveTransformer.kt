...
class PerspectiveTransformer : Transformer() {
    ...
    init {
        ...
        register("v1_18_2/net/minecraft/client/render/Camera") { classNode: ClassNode ->
            transformGameCamera(
                classNode
            )
        }
    ...
    private fun transformEntity(classNode: ClassNode) {
        val changeLookDirection = Identifier.parse("v1_18_2/net/minecraft/entity/Entity#changeLookDirection(DD)V")
    ...
    private fun transformGameCamera(classNode: ClassNode) {
        val update = Identifier.parse("v1_18_2/net/minecraft/client/render/Camera#update(Lv1_18_2/net/minecraft/world/BlockView;Lv1_18_2/net/minecraft/entity/Entity;ZZF)V")
    ...
    private fun transformRotationCalls(methodNode: MethodNode) {
        val entity = Identifier.parse("v1_18_2/net/minecraft/entity/Entity")
        val playerEntity = Identifier.parse("v1_18_2/net/minecraft/entity/player/PlayerEntity")
        val getPitch = Identifier.parse("v1_18_2/net/minecraft/entity/Entity#getPitch(F)F")
        val prevPitch = Identifier.parse("v1_18_2/net/minecraft/entity/Entity#prevPitch")
        val getYaw = Identifier.parse("v1_18_2/net/minecraft/entity/Entity#getYaw(F)F")
        val prevYaw = Identifier.parse("v1_18_2/net/minecraft/entity/Entity#prevYaw")
