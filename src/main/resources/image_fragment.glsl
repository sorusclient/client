...
void main() {
    ...
    vec4 textureColor = texture(ourTexture, coordinate);
    ...
    if (positionFrag[0] < dimensionsFrag[0] + dimensionsFrag[2] - cornerRadiusFrag && positionFrag[0] > dimensionsFrag[0] + cornerRadiusFrag) {
        fragColor = vec4(color2[0], color2[1], color2[2], color2[3] * (1 - smoothstep(dimensionsFrag[3] / 2 - value, dimensionsFrag[3] / 2, abs(positionFrag[1] - (dimensionsFrag[1] + dimensionsFrag[3] / 2)))));
        ...
        fragColor = vec4(color2[0], color2[1], color2[2], color2[3] * (1 - smoothstep(dimensionsFrag[2] / 2 - value, dimensionsFrag[2] / 2, abs(positionFrag[0] - (dimensionsFrag[0] + dimensionsFrag[2] / 2)))));
    } else {
        ...
        fragColor = vec4(color2[0], color2[1], color2[2], color2[3] * (1 - smoothstep(cornerRadiusFrag - value, cornerRadiusFrag, distance(point, positionFrag))));
    }
