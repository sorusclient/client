...
void main() {
    ...
    if (positionFrag[0] < dimensionsFrag[0] + dimensionsFrag[2] - cornerRadiusFrag && positionFrag[0] > dimensionsFrag[0] + cornerRadiusFrag) {
        gl_FragColor = vec4(color[0], color[1], color[2], color[3] * (1 - smoothstep(dimensionsFrag[3] / 2 - value, dimensionsFrag[3] / 2, abs(positionFrag[1] - (dimensionsFrag[1] + dimensionsFrag[3] / 2)))));
        ...
        gl_FragColor = vec4(color[0], color[1], color[2], color[3] * (1 - smoothstep(dimensionsFrag[2] / 2 - value, dimensionsFrag[2] / 2, abs(positionFrag[0] - (dimensionsFrag[0] + dimensionsFrag[2] / 2)))));
    } else {
        ...
        gl_FragColor = vec4(color[0], color[1], color[2], color[3] * (1 - smoothstep(cornerRadiusFrag - value, cornerRadiusFrag, distance(point, positionFrag))));
    }
