...
public class Flexible implements Constraint {
    ...
    public double getWidthValue(Component.Runtime componentRuntime) {
        ...
        for (double[] component : placedComponents) {
            ...
            boolean canInteractLeft = component[0] < componentRuntime.getX() + padding;
            ...
            boolean canInteractRight = component[0] > componentRuntime.getX() - padding;
    ...
    public double getHeightValue(Component.Runtime componentRuntime) {
        ...
        for (double[] component : placedComponents) {
            ...
            boolean canInteractTop = component[1] < componentRuntime.getY() + padding;
            ...
            boolean canInteractBottom = component[1] > componentRuntime.getY() - padding;
