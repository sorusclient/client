...
import com.github.sorusclient.client.module.impl.environmentchanger.EnvironmentChanger.Weather
...
object EnvironmentChangerHook {
    ...
    fun modifySkyAngle(angle: Float): Float {
        val environmentChanger = ModuleManager.get<EnvironmentChanger>()
