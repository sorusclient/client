...
import v1_18_1.net.minecraft.client.gui.hud.BossBarHud
import v1_18_1.net.minecraft.client.gui.hud.ClientBossBar
import v1_18_1.net.minecraft.world.World
...
class WorldImpl(private val world: World) : IWorld {
    ...
    private val bossBarsField: Field = run {
        val bossBars = Identifier.parse("v1_18_1/net/minecraft/client/gui/hud/BossBarHud#bossBars")
